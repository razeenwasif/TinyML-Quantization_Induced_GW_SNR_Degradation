...
\begin{tikzpicture}[font=\footnotesize]
  ...
  % Qi 2024: fixed-point BNS FPGA, accuracy changes rather than reach
...
\end{tikzpicture}
\caption{Synthesis sketch of sensitivity preservation versus weight precision. BBH results remain close to FP32 through mixed FP16/INT8 (Chaturvedi et al.\ 2022), while BNS sensitivity is conjectured to degrade more sharply; Qi et al.\ (2024) provides the only GW fixed-point deployment anchor in the included set, but reports accuracy rather than SNR or distance reach. The green region is the missing target: BNS-class sensitivity at INT8 or below on a sub-watt microcontroller.}
\label{fig:bitwidth}
\end{figure}
